            ...
            if (timeToDate > 0 && now >= dealstartdate) {
                ...
                if (topdeals == 1) {
                    var html =
                        ...
                        days +
                        '</span><p class="topdeals-text border-primary fw-normal border-top">Days</p></li>  <li class="px-md-3"><span class="topdeals-text">' +
                        hours +
                        '</span><p class="topdeals-text border-primary fw-normal border-top">Hours</p></li> <li class="px-md-3"><span class="topdeals-text">' +
                        minutes +
                        '</span><p class="topdeals-text border-primary fw-normal border-top">Minutes</p></li> <li class="px-md-3"><span class="topdeals-text">' +
                        seconds +
                        '</span><p class="topdeals-text border-primary fw-normal border-top">Seconds</p></li></ul>';
