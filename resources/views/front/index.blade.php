        ...
        <div class="home4-slider swiper-container">
            <div class="swiper-wrapper">
                <div class="home4-slide-item swiper-slide" data-swiper-autoplay="5000">
                    <div class="home4-slide-image"><img src="/assets/images/slider/home4/slide-1.webp" alt="Home 4 Slider Image"></div>
                    <div class="home4-slide-content">
                        <span class="category">HOME DECOR</span>
                        <h2 class="title">Monamii Jade-green<br> Wall Clock</h2>
                        <div class="link"><a href="shop.html" class="btn btn-black btn-outline-hover-black">shop now</a></div>
                    </div>
                </div>
                <div class="home4-slide-item swiper-slide" data-swiper-autoplay="5000">
                    <div class="home4-slide-image"><img src="/assets/images/slider/home4/slide-2.webp" alt="Home 4 Slider Image"></div>
                    <div class="home4-slide-content">
                        <span class="category">HOME DECOR</span>
                        <h2 class="title">Homemade Creative Food<br> Cutting Board</h2>
                        <div class="link"><a href="shop.html" class="btn btn-black btn-outline-hover-black">shop now</a></div>
                    </div>
                </div>
                <div class="home4-slide-item swiper-slide" data-swiper-autoplay="5000">
